...
##                                                                                     3.3V  #   1
#                                                                                        5V  #   2
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33}     [get_ports {F_SYSCLK}] ;        #   3
#                                                                                        5v  #   4
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33}     [get_ports {F_PCLK_M}];         #   5
#                                                                                    ground  #   6
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33}     [get_ports {F_PCLK_T}];         #   7
set_property -dict {PACKAGE_PIN V6  IOSTANDARD LVCMOS33}     [get_ports {F_TRIGIN_TOP  }];   #   8
#                                                                                    ground  #   9
set_property -dict {PACKAGE_PIN Y6  IOSTANDARD LVCMOS33}     [get_ports {F_SCLK}];           #  10
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports {F_data_out_debug }];              #  11
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports {F_SIN }];           #  12
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports {F_DAT_A_T2F }];     #  13
#                                                                                    ground  #  14
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports {F_SSTCLK }];        #  15
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports {F_AUXTRIG}];        #  16 
#                                                                                      3.3V  #  17
set_property -dict {PACKAGE_PIN y7  IOSTANDARD LVCMOS33}     [get_ports {F_TRIG}];           #  18 
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports {F_PCLK_B }];        #  19
#                                                                                    ground  #  20
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 }[get_ports {   }];              #  21
set_property -dict {PACKAGE_PIN F20 IOSTANDARD LVCMOS33}     [get_ports {F_T_SHOUT}];        #  22
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports {F_TOK_B_F2M }];     #  23
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports {F_T_SCLK  }];       #  24
#                                                                                    ground  #  25 
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports {F_T_SIN }];         #  26
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33}     [get_ports {F_TOK_A_B2F}];      #  27
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33}     [get_ports {F_TOK_B_M2F}];      #  28
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports {F_TOK_A_F2T }];     #  29 
#                                                                                    ground  #  30 
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports {F_TESTMODE }];      #  31
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports {F_SYNC }];          #  32
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports {F_SDA }];           #  33
#                                                                                    ground  #  34 
#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports {F_SCL }];           #  35
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports {F_SCL  }];           #  33
#                                                                                    ground  #  34 
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { F_SDA}];           #  35
set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports {F_DAT_B_M2F }];     #  36
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports {F_DAT_B_F2M }];     #  37
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports {F_TRIGIN_BOT }];    #  38
#                                                                                    ground  #  39 
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports {F_DAT_A_F2B }];     #  40
